...
namespace Dingdong_Pay.Areas.Transaction.Controllers
{
    public class BillsController : Controller
    {
        ...
        public ActionResult GetBillsList()
        {
                            ...
                            using (SqlDataReader sdr = cmdSql.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ...
                                    data.Add(new mBills
                                    {
                                        ...
                                        DueMonth = Convert.ToInt32(sdr["GroupMonth"]) == 13? "Overdue" : Convert.ToDateTime(sdr["DueDate"]).ToString("MMMM"),
            ...
            data = data.Skip(start).Take(length).ToList<mBills>();
