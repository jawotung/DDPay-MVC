...
(function () {
    ...
    $(document).ready(function () {
        ...
        $("#frmExpenses").submit(function (e) {
            e.preventDefault();
            ajax.formData = $('#frmExpenses').serializeArray();
            ajax.formAction = '/Transaction/Expenses/SaveData';
            ajax.setJsonData().sendData().then(function () {
                Reload();
            });
        });
        $("#btnSaveForm").click(function (e) {
            $("#frmExpenses").addClass('was-validated');
        });
        $('#btnDelete').click(function () {
            ajax.msg = "Are you sure you want to delete this data?";
            ajax.confirmAction().then(function (approve) {
                if (approve) {
                    ajax.formAction = '/Transaction/Expenses/DeleteData';
    ...
    function GetMonthlyList() {
        var HtmlEl = "";
        ajax.formAction = "/Transaction/Expenses/GetMonthlyList";
    ...
    function GetDailyList() {
        var HtmlEl = "";
        ajax.formAction = "/Transaction/Expenses/GetDailyList";
    ...
    function GetDetailList(InputDate) {
        var HtmlEl = "";
        ajax.formAction = "/Transaction/Expenses/GetDetailList";
    ...
    function cancelUserForm() {
        ajax.clearFromData("frmExpenses");
    }
    function Reload() {
        cancelUserForm();
        GetMonthlyList();
